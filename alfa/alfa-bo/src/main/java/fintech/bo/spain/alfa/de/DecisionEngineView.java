...
@Slf4j
@SpringView(name = DecisionEngineView.NAME)
public class DecisionEngineView extends VerticalLayout implements View {

    public static final String NAME = "decision-engine";

    @Autowired
    private DecisionEngineListComponentProvider provider;
