...
@Component
public class AddClientToSegment implements ActivityListener {
    ...
    public AddClientToSegment(String segment) {
        this.segment = segment;
    }

    @Override
    public void handle(ActivityContext context) {
        clientService.addToSegment(context.getClientId(), this.segment);
    }
}
