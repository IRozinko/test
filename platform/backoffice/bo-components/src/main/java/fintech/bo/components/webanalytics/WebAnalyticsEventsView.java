...
@Slf4j
@SpringView(name = WebAnalyticsEventsView.NAME)
public class WebAnalyticsEventsView extends VerticalLayout implements View {

    public static final String NAME = "web-analytics-events";

    @Autowired
    private WebAnalyticsEventListComponentProvider provider;
