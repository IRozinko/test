...
@Slf4j
@Component
public class CreditLineBreakLoanStrategy implements BreakLoanStrategy {
    ...
    @Autowired
    public CreditLineBreakLoanStrategy(InvoiceService invoiceService, TransactionService transactionService, LoanService loanService, ScheduleService scheduleService) {
