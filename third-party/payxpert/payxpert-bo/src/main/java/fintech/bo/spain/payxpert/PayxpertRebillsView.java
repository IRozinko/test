...
@Slf4j
@SpringView(name = PayxpertRebillsView.NAME)
public class PayxpertRebillsView extends VerticalLayout implements View {

    public static final String NAME = "payxpert-rebills";

    @Autowired
    private PayxpertRebillListComponentProvider provider;
