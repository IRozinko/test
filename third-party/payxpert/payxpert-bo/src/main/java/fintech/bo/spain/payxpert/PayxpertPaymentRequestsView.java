...
@Slf4j
@SpringView(name = PayxpertPaymentRequestsView.NAME)
public class PayxpertPaymentRequestsView extends VerticalLayout implements View {

    public static final String NAME = "payxpert-payment-requests";

    @Autowired
    private PayxpertPaymentRequestListComponentProvider provider;
