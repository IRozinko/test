...
public class DowJonesListComponent extends VerticalLayout implements BoComponent {
    ...
    private DowJonesDataProvider dataProvider;
    ...
    public void setUp(BoComponentContext context) {
        ...
        this.dataProvider = new DowJonesDataProvider(this.db).setComponentContext(context);
    ...
    public Component grid() {
        ...
        builder.addColumn(REQUEST.ERROR);
        builder.addColumn(REQUEST.REQUEST_BODY);
        builder.addColumn(REQUEST.REQUEST_URL);
        builder.addColumn(REQUEST.RESPONSE_BODY);
        builder.addColumn(REQUEST.RESPONSE_STATUS_CODE);
        builder.addColumn(REQUEST.STATUS);
        builder.addAuditColumns(REQUEST);
        builder.sortDesc(REQUEST.ID);
