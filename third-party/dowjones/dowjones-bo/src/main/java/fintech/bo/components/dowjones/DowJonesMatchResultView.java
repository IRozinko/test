...
@Slf4j
@SpringView(name = DowJonesMatchResultView.NAME)
public class DowJonesMatchResultView extends VerticalLayout implements View {

    public static final String NAME = "dowjones-match-result";

    @Autowired
    private DowJonesMatchResultListComponentProvider provider;
