...
@Slf4j
@SpringView(name = DowJonesView.NAME)
public class DowJonesView extends VerticalLayout implements View {

    public static final String NAME = "DowJones-response";

    @Autowired
    private DowJonesListComponentProvider provider;
