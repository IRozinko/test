...
public class IovationTransactionListComponent extends VerticalLayout implements BoComponent {
    ...
    private IovationTransactionDataProvider dataProvider;
    ...
    public void setUp(BoComponentContext context) {
        ...
        this.dataProvider = new IovationTransactionDataProvider(this.db).setComponentContext(context);
