...
@Slf4j
@SpringView(name = InstantorView.NAME)
public class InstantorView extends VerticalLayout implements View {

    public static final String NAME = "instantor";

    @Autowired
    private InstantorListComponentProvider provider;
