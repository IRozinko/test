...
import com.equifax.xml.xmlschema.interconnect.InterConnectResponseType;
import com.equifax.xml.xmlschema.interconnect.ObjectFactory;
    ...
    private static final Supplier<JAXBContext> jaxbContext = Suppliers.memoize(() -> {
        try {
            return JAXBContext.newInstance(
                ObjectFactory.class,
                InterConnectResponseType.class,
                ArrayList.class
            );
